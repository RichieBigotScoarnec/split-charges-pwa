...
| **P1b** | **Les 37 points de passage, puis la migration EN DERNIER.** Chacun avec un verdict écrit — compte, ou ne compte pas : 3 lecteurs de liste (`variable-charges:330`, `fixed-charges:349`, `quick-add:813`), 16 lecteurs d'historique (`dbGet('periods')`, dont 5 acceptent une injection), 18 traversées à nom de collection en dur. Les 33 `getState` suivent gratuitement si la fusion est faite dans les 2 chargeurs. La migration des 3 charges `perimetre: 'solo'` (1 mois, `2026-09`, 0 sans propriétaire — relevé sur sauvegarde le 2026-09-16) vient quand tout sait les lire | — |
