...
const CACHE_VERSION = 'df3e81f56512';
...
const STATIC_ASSETS = [
  ...
  './js/utils/bascule-poche.js',
  './js/utils/budget-propose.js',
  './js/utils/budgets.js',
  './js/utils/cadre.js',
  ...
  './js/utils/date.js',
  './js/utils/decomposition.js',
  './js/utils/echelle.js',
  './js/utils/detail.js',
  './js/utils/rapport-mensuel.js',
  './js/utils/debug.js',
  './js/utils/diagnostics.js',
  './js/utils/ecouteur.js',
  './js/utils/entete.js',
  './js/utils/enveloppes.js',
  './js/utils/explication-solde.js',
  './js/utils/format.js',
  ...
  './js/utils/recherche-montant.js',
  './js/utils/recherche-texte.js',
  './js/utils/recurrence.js',
  './js/utils/rejeu-annonce.js',
  './js/utils/repartition.js',
  './js/utils/retour.js',
  './js/utils/reprise.js',
  ...
  './js/modules/detail-depenses.js',
  './js/modules/rapport.js',
  ...
  './js/modules/migration-poches.js',
